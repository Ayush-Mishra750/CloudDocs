            ...
            >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div
                  ...
                  onClick={() => window.open(`/view-file/${file._id}`, '_blank')}
                >
                  <div className="w-10 h-10 rounded-2xl bg-purple-50 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform">
                    {getFileIcon(file.mimeType)}
                  </div>

                  <div className="space-y-1">
                    <div className="flex items-center space-x-2">
                      <h3 className="text-sm font-extrabold text-slate-900 group-hover:text-blue-600 transition-colors">{file.name}</h3>
                      {file.isPublic && (
                ...
                <div className="flex items-center space-x-2 self-end sm:self-auto">
                  <button
                    onClick={() => window.open(`/view-file/${file._id}`, '_blank')}
                    className="px-4 py-2 rounded-xl bg-blue-50 hover:bg-blue-100 text-blue-700 font-bold text-xs border border-blue-200 transition-colors flex items-center space-x-1.5"
                    title="Open document in new page"
                  >
